          ...
          <div className="space-y-8">
            ...
            <p className="text-[#f9f7f2]/50 leading-relaxed text-lg italic font-serif">
              ...
              <div className="flex space-x-4">
                <a href="https://www.instagram.com/explore/locations/109249058262612/ajwa-bakers-restaurant-daska/" target="_blank" rel="noopener noreferrer" className="bg-white/5 p-4 rounded-full hover:bg-[#009a44] transition-all duration-300 transform hover:scale-110">
                  <Instagram size={20} />
                </a>
                <a href="https://www.facebook.com/Ajwa0526615151/" target="_blank" rel="noopener noreferrer" className="bg-white/5 p-4 rounded-full hover:bg-[#009a44] transition-all duration-300 transform hover:scale-110">
                  <Facebook size={20} />
                </a>
                <a href="https://wa.me/92526615151" target="_blank" rel="noopener noreferrer" className="bg-white/5 p-4 rounded-full hover:bg-[#009a44] transition-all duration-300 transform hover:scale-110">
